  ...
  return (
    <div className="p-4 sm:p-6  min-h-screen flex items-center justify-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
        {/* Personal Information */}
        <div className="bg-white border p-4 sm:p-6 rounded-lg shadow-md">
          <h2 className="text-lg font-semibold mb-4">Personal Information</h2>
        ...
        {/* Profile Photo */}
        <div className="bg-white border p-4 sm:p-6 rounded-lg shadow-md text-center">
          <h2 className="text-lg font-semibold mb-4">Your Photo</h2>
          <div className="mb-4">
            {profileImage ? (
              <img
            ...
            <div className="mt-1 text-sm text-red-600 cursor-pointer">
              Delete
            </div>
          </div>
          <div
            className="border-dashed border-2 p-4 sm:p-6 rounded-lg cursor-pointer"
            onClick={() => fileInputRef.current.click()}
          >
            <p className="text-gray-600 text-sm">Click to upload or drag and drop</p>
